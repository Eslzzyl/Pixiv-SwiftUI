                    ...
                    if let currentIllust {
                        VStack(alignment: .leading, spacing: 16) {
                            IllustDetailInfoSection(
                                ...
                                authorLatestIllusts: currentDetailViewModel.authorLatestIllusts,
                                isLoadingAuthorLatestIllusts: currentDetailViewModel.isLoadingAuthorLatestIllusts,
                                onFetchAuthorLatestIllusts: currentDetailViewModel.fetchAuthorLatestIllustsIfNeeded,
